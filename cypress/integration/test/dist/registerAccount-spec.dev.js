...
context("Registering Some Account", function () {
  it("Alpha", function () {
    cy.server({
      onAnyRequest: function onAnyRequest(route, proxy) {
  ...
  it("Opening Alpha Email", function () {
  ...
  it("Opening Beta Email", function () {
  ...
  it("Opening Charlie Email", function () {
    ...
    cy.get('.tab-bar > :nth-child(1)').click({
      force: true
    }).wait(2000);
    cy.get('.tab-bar > :nth-child(2)').click({
      force: true
